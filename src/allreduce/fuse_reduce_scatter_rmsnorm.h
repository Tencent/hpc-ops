...
#ifndef SRC_ALLREDUCE_FUSE_REDUCE_SCATTER_RMSNORM_H_
#define SRC_ALLREDUCE_FUSE_REDUCE_SCATTER_RMSNORM_H_
...
#endif  // SRC_ALLREDUCE_FUSE_REDUCE_SCATTER_RMSNORM_H_
