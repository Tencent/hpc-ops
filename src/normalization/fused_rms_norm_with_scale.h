...
#ifndef SRC_NORMALIZATION_FUSED_RMS_NORM_WITH_SCALE_H_
#define SRC_NORMALIZATION_FUSED_RMS_NORM_WITH_SCALE_H_
...
#endif  // SRC_NORMALIZATION_FUSED_RMS_NORM_WITH_SCALE_H_
