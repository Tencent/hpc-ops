...
void launch_stem_oam_gemm_dim192(void *block_logits_ptr, const void *qflat_ptr,
...
void stem_oam_gemm_dim192_async(void *block_logits_ptr, const void *qflat_ptr,
                                ...
                                cudaStream_t stream) {
  launch_stem_oam_gemm_dim192<128, 16, 192>(block_logits_ptr, qflat_ptr, kflat_ptr, vbias_ptr,
