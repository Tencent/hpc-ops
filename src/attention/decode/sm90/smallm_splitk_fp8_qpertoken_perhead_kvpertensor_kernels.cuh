...
#ifndef SRC_ATTENTION_DECODE_SM90_SMALLM_SPLITK_FP8_QPERTOKEN_PERHEAD_KVPERTENSOR_KERNELS_CUH_
#define SRC_ATTENTION_DECODE_SM90_SMALLM_SPLITK_FP8_QPERTOKEN_PERHEAD_KVPERTENSOR_KERNELS_CUH_
...
template <typename Tout, typename Tin, int kTileM, int kTileN, int kTileK, int kTileV,
          ...
          int kStage, int kSplitK, int kSplitMinLen, bool kHasPScale = false>
__global__ void
...
#pragma unroll
    ...
    // Per-row P_scale / P_scale_inv cache, indexed by the same iqhead logic as qkscales.
...
#endif  // SRC_ATTENTION_DECODE_SM90_SMALLM_SPLITK_FP8_QPERTOKEN_PERHEAD_KVPERTENSOR_KERNELS_CUH_
