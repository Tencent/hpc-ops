...
template <int kTileM, int kTileN, int kTileK, int kTileV, int kBlockSize, int kMaxSplitK,
          int kStage = 2>
static void launch_smallm_fp8_qpertoken_perhead_kvpertensor_dim128_dynamic_adaptive_splitk_kernel(
...
bool smallm_fp8_qpertoken_perhead_kvpertensor_dim128_dynamic_adaptive_async(
  ...
  auto launch_ks = [&](auto splitk_tag, auto tilem_tag, auto block_size_tag, auto kstage_tag) {
    ...
    launch_smallm_fp8_qpertoken_perhead_kvpertensor_dim128_dynamic_adaptive_splitk_kernel<
