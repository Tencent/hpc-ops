...
#ifndef SRC_ATTENTION_DECODE_SM100_SMALLM_FP8_CLC_QPERTOKEN_PERHEAD_KVPERTENSOR_KERNELS_CUH_
#define SRC_ATTENTION_DECODE_SM100_SMALLM_FP8_CLC_QPERTOKEN_PERHEAD_KVPERTENSOR_KERNELS_CUH_
...
#pragma unroll
    ...
    while (true) {
      ...
      load_block_ids(shm_blkids + istage_q * num_seq_max_blocks,
                     block_ids_ptr + task_info.ibatch * num_seq_max_blocks +
                         task_info.ichunk * task_info.num_blocks_per_chunk,
...
#endif  // SRC_ATTENTION_DECODE_SM100_SMALLM_FP8_CLC_QPERTOKEN_PERHEAD_KVPERTENSOR_KERNELS_CUH_
