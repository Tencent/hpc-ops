...
#include "src/attention/decode/sm100/static/smallm_fp8_qkpertoken_perhead_vperhead_dim128_static_clc_nosplitk_kernels.cuh"
...
void launch_smallm_fp8_qkpertoken_perhead_vperhead_dim128_static_clc_nosplitk_kernel(
  ...
  auto kernel = kernels::
      smallm_attention_decode_fp8_qkpertoken_perhead_vperhead_static_1sm_clc_nosplitk_kernel<
...
bool smallm_fp8_qkpertoken_perhead_vperhead_dim128_static_async(
  ...
  auto launch = [&](auto tilem_tag) {
    ...
    launch_smallm_fp8_qkpertoken_perhead_vperhead_dim128_static_clc_nosplitk_kernel<
