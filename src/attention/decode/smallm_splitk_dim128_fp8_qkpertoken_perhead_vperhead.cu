...
#include "src/attention/decode/smallm_splitk_fp8_qkpertoken_perhead_vperhead_kernels.cuh"
...
void launch_attention_decode_fp8_dim128_smallm_splitk(
  ...
  auto KS = make_tensor(
      ...
      make_stride(num_scale_per_row * num_head_k, Int<1>{}, num_scale_per_row,
                  ldK / kScaleByteSize));
