...
void launch_attention_decode_bf16_dim80(void *y_ptr, const void *q_ptr, void *kvcache_ptr,
                                        ...
                                        int max_num_blocks, int ldY, int ldQ, cudaStream_t stream) {
...
bool attention_decode_bf16_headdim80_async(void *y_ptr, const void *q_ptr, void *kvcache_ptr,
  ...
  if (heads_per_group == 8 || heads_per_group == 4) {
    ...
    launch_attention_decode_bf16_dim80<kHeadsPerGroup, kTileM, kTileN, kTileK, kTileV, kBlockSize>(
