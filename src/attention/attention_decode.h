...
#ifndef SRC_ATTENTION_ATTENTION_DECODE_H_
#define SRC_ATTENTION_ATTENTION_DECODE_H_
...
bool attention_decode_bf16_headdim80_async(void *y_ptr, const void *q_ptr, void *kcache_ptr,
...
bool attention_decode_bf16_headdim128_smallm_async(
    ...
    int num_dim_qk, int num_dim_v, int num_kvcache_blocks, int block_size, int num_seq_max_blocks,
    int ldY, int ldQ, int ldK, int ldV, cudaStream_t stream);

}  // namespace attention
}  // namespace hpc

#endif  // SRC_ATTENTION_ATTENTION_DECODE_H_
