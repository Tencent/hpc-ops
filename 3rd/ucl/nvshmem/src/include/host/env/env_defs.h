...
NVSHMEMI_ENV_DEF(DISABLE_MPS_CHECK, bool, true, NVSHMEMI_ENV_CAT_OTHER,
                "Skip checking Multi-Process Service (MPS) of GPUs")
...
NVSHMEMI_ENV_DEF(IB_TIMEOUT, int, 20, NVSHMEMI_ENV_CAT_TRANSPORT, "Timeout attributes for QP")
NVSHMEMI_ENV_DEF(IB_MODIFY_QP_RETRY_CNT, int, 100, NVSHMEMI_ENV_CAT_TRANSPORT, "Retry count for QP modification")

NVSHMEMI_ENV_DEF(GOR_QP_SPORT_1, int, 60000, NVSHMEMI_ENV_CAT_TRANSPORT, "GOR qp src port 1")
NVSHMEMI_ENV_DEF(GOR_QP_SPORT_2, int, 60051, NVSHMEMI_ENV_CAT_TRANSPORT, "GOR qp src port 2")
NVSHMEMI_ENV_DEF(GOR_QP_SPORT_3, int, 57663, NVSHMEMI_ENV_CAT_TRANSPORT, "GOR qp src port 3")
NVSHMEMI_ENV_DEF(GOR_QP_SPORT_4, int, 57804, NVSHMEMI_ENV_CAT_TRANSPORT, "GOR qp src port 4")
